...
INSERT INTO `django_flatpage` VALUES (2,'/','Татуаж в Киеве - Главная','<h2 class=\"text-center\">Перманентный макияж - это процедура, которая сделает Вас красивой</h2>',0,'flatpages/home.html',0),(12,'/contacts/','Татуаж в Киеве - Контакты','',0,'flatpages/contacts.html',0),(14,'/prices/','Татуаж в Киеве - Цены','',0,'flatpages/prices.html',0);
...
INSERT INTO `django_flatpage_sites` VALUES (78,2,2),(79,12,2),(81,14,2);
...
-- Dump completed on 2014-09-22  8:39:21
