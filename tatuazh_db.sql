...
--
-- Host: localhost    Database: tatuazhkiev
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$8wmhN0jRL1TB$CZya8aqiHl5QFX0idhUo3F9Yt2LZAbxthPD5Nzu8pPs=','2014-09-20 19:15:33',1,'user','','','olexandr.kara@gmail.com',1,1,'2014-08-29 09:07:09'),(2,'pbkdf2_sha256$12000$DemgsHfST05O$iKKEP5olZgffwxcXabQ/pqNFGqXa+LN16PyQhC/2FiU=','2014-09-10 08:19:46',0,'anna','Анна','Кара','kiev.tatuazh@gmail.com',1,1,'2014-09-10 08:16:36');
...
INSERT INTO `django_flatpage` VALUES (2,'/','Татуаж в Киеве - Главная','<h2 class=\"text-center\">Перманентный макияж - это процедура, которая сделает Вас красивой</h2>',0,'flatpages/home.html',0),(12,'/contacts/','Татуаж в Киеве - Контакты','',0,'flatpages/contacts.html',0);
...
INSERT INTO `django_flatpage_sites` VALUES (78,2,2),(79,12,2);
